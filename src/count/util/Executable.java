...
public class Executable 
{
    ...
    public static final String VERSION = "III 16.0623(dev)";
    ...
    public static String getStandardRuntimeInfo()
    {
        ...
        message.append(getStandardHeader("System: ")).append(system).append("\n");
        message.append(getStandardHeader("Java engine:")).append(java).append("\n");
        message.append(getStandardHeader("Date: ")).append(now);
