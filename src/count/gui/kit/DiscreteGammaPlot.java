...
/**
 * A plot illustrating the density function for a gamma distribution and
...
//    {
//        this(distribution, Mien.GAMMA_PLOT_PARTITIONS);
//    }

    public DiscreteGammaPlot(DiscreteGamma distribution, int num_categories)
    {
        this(distribution, num_categories, Mien.GAMMA_PLOT_WIDTH, Mien.GAMMA_PLOT_HEIGHT);
    }
               ...
               int y)
    {
        ...
        // draw the tics
        double unit_x = Mien.roundToMostSignificantDigit(max_value_x/6.0,null, true);  // just a few tics 
